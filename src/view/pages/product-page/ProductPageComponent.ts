...
import { PurchaseFormComponent } from '../../components/purchase-form/PurchaseFormComponent';
...
export class ProductPageComponent extends BaseComponent<ProductPageComponentProps> {
    ...
    protected addListeners() {
        ...
        this.buyButton.addEventListener('click', () => {
            if (this.props.cart.getData().has(this.props.product)) {
                this.navigateToCartModal();
            } else {
    ...
    private navigateToCartModal(): void {
