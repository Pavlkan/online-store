...
export type Categories = Map<string, Product[]>;
export type Brands = Map<string, Product[]>;
...
export class Assortment {
    ...
    constructor() {
        ...
        this.categories = this.createProductGroup('category');
        this.brands = this.createProductGroup('brand');
    }
    ...
    private createProductGroup(group: string): Categories | Brands {
        return this.getAssortment().reduce((groupAcc: Categories | Brands, product: Product) => {
            ...
            if (groupElement) {
                ...
                groupAcc.set(product[key], [product]);
            }
            return groupAcc;
        }, new Map());
    }
